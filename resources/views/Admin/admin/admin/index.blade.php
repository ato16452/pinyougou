    ...
    <div class="wrapper">
                ...
                <ul class="sidebar-menu"  >
				    ...
				    <li class="treeview">
				        ...
				        <ul class="treeview-menu">
				            ...
				            <li id="admin-login">
				                <a href="/admin/seller_1" target="iframe">
				                    <i class="fa fa-circle-o"></i>商家审核
				                </a>
				            </li>
							<li id="admin-login">
				                <a href="/admin/seller" target="iframe">
					...
					<li class="treeview">
				        ...
				        <ul class="treeview-menu">
							...
							<li id="admin-login">
				                <a href="/admin/content" target="iframe">
                     ...
                     <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                             ...
                             <li id="admin-link">
                                <a href="/admin/link" target="iframe">
        ...
        <div class="content-wrapper">
			<iframe width="100%" id="iframe" name="iframe"	onload="SetIFrameHeight()" 
					frameborder="0" src="/admin/home"></iframe>
