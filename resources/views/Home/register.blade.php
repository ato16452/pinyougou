...
<body>
	<div class="register py-container ">
		...
		<div class="registerArea">
			...
			<div class="info">
				<form class="sui-form form-horizontal" action="/register/insert" method="post">
					{{ csrf_field() }}
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="phonecheck" placeholder="短信验证码" class="input-xfat input-xlarge">  <a href="#">获取短信验证码</a>
						</div>
					</div>
